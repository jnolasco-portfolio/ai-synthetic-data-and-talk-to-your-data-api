...
ALTER TABLE Departments ADD CONSTRAINT FK_Departments_ManagerID FOREIGN KEY (manager_id) REFERENCES Employees(employee_id);
ALTER TABLE Library_Branches ADD CONSTRAINT FK_Library_Branches_ManagerID FOREIGN KEY (manager_id) REFERENCES Employees(employee_id);
